...
using MotorsDataAccess;

namespace AngularPOC.Controllers
{
    public class ModelsController : ApiController
    {
        private MyWorksDBEntities db = new MyWorksDBEntities();
        ...
        {
            return db.Models.Include(X => X.Brand);
        }
        ...
        {
            Model model = db.Models.Include(X => X.Brand).SingleOrDefault(X => X.Id == id);
            if (model == null)
            {
                return NotFound();
            }
        ...
        public IHttpActionResult PostModel(Model model)
        {
            ...
            model.Brand = db.Brands.Find(model.Brand.Id);
            db.Models.Add(model);
            db.SaveChanges();
